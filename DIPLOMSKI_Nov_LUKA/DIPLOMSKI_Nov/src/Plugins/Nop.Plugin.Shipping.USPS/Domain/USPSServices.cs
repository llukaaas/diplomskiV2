...
public static class USPSServices
{
    ...
    /// </summary>
    private static readonly Dictionary<string, string> _domesticServices = new()
    {
    ...
    /// </summary>
    private static readonly Dictionary<string, string> _internationalServices = new()
    {
    ...
    public static string GetServiceIdDomestic(string service)
    {
        ...
        if (_domesticServices.TryGetValue(service, out var value))
            serviceId = value;
    ...
    public static string GetServiceIdInternational(string service)
    {
        ...
        if (_internationalServices.TryGetValue(service, out var value))
            serviceId = value;
